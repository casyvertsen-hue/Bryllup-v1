...
<head>
  ...
  <style>
    ...
    header {background:url(img src="https://drive.google.com/uc?export=view&id=1fG54F0l1mc9q-ux-rXeWerNG0PhLseRS") center/cover no-repeat; color:white; padding:80px 20px;}
